import * as assert from '@hapi/hoek/lib/assert';
import * as clone from '@hapi/hoek/lib/clone';
import * as error from '@hapi/hoek/lib/error';
import * as escapeHtml from '@hapi/hoek/lib/escapeHtml';
import * as formula from '@sideway/formula';
import * as reach from '@hapi/hoek/lib/reach';
import * as deepEqual from '@hapi/hoek/lib/deepEqual';
import * as pinpoint from '@sideway/pinpoint';
import * as merge from '@hapi/hoek/lib/merge';
import * as ignore from '@hapi/hoek/lib/ignore';
import * as applyToDefaults from '@hapi/hoek/lib/applyToDefaults';
import * as topo from '@hapi/topo';
import * as domain from '@sideway/address/lib/domain';
import * as email from '@sideway/address/lib/email';
import * as ip from '@sideway/address/lib/ip';
import * as escapeRegex from '@hapi/hoek/lib/escapeRegex';
import * as tlds from '@sideway/address/lib/tlds';
import * as uri from '@sideway/address/lib/uri';
...
const require$$0$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(assert);

const require$$1$5 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(clone);

var cache = {};

var common = {};

const require$$1$4 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(error);
...
const require$$2$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(escapeHtml);

const require$$3$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(formula);
	...
	(function (exports$1) {
		...
		exports$1.Report = class {
		    ...
		    _template(messages, code) {
		        ...
		        return exports$1.template(this.value, messages, code || this.code, this.state, this.prefs);
		    }
		};
		...
		exports$1.template = function (value, messages, code, state, prefs) {
		...
		exports$1.label = function (flags, state, prefs, messages) {
		    ...
		    return exports$1.template(null, prefs.messages, 'root', state, prefs) ||
		        messages && exports$1.template(null, messages, 'root', state, prefs) ||
		        'value';
		};


		exports$1.process = function (errors, original, prefs) {

		    if (!errors) {
		        return null;
		    }

		    const { override, message, details } = exports$1.details(errors);
		    if (override) {
		        return override;
		    }
		...
		exports$1.details = function (errors, options = {}) {
...
const require$$2$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(reach);
	...
	(function (exports$1) {
		...
		exports$1.Manager = class {
		    ...
		    register(source, target) {
		        ...
		        target = target === undefined ? exports$1.toParent : target;
...
function requireTemplate () {
	...
	(function (module, exports$1) {
		...
		const Assert = require$$0$1;
		const Clone = require$$1$5;
		const EscapeHtml = require$$2$3;
		const Formula = require$$3$2;
...
function requireMessages () {
	...
	(function (exports$1) {
		...
		exports$1.compile = function (messages, target) {
		...
		exports$1.decompile = function (messages) {
		...
		exports$1.merge = function (base, extended) {
...
function requireCommon () {
	...
	(function (exports$1) {
		...
		const Assert = require$$0$1;
		const AssertError = require$$1$4;

		const Pkg = require$$2$4;
		...
		exports$1.assertOptions = function (options, keys, name = 'Options') {
		...
		exports$1.isSchema = function (schema, options = {}) {
		    ...
		    const any = schema && schema[exports$1.symbols.any];
		    if (!any) {
		        return false;
		    }

		    Assert(options.legacy || any.version === exports$1.version, 'Cannot mix different versions of joi schemas');
		    return true;
		};
...
function requireCompile () {
	...
	(function (exports$1) {
		...
		exports$1.schema = function (Joi, config, options = {}) {
		...
		exports$1.compile = function (root, schema, options = {}) {
		    ...
		    if (typeof schema !== 'object' ||
		        ...
		        return exports$1.schema(root, schema, { appendPath: true });          // Will error if schema contains other versions
		    }
		...
		exports$1.when = function (schema, condition, options) {
		    ...
		    if (options.switch === undefined) {
		        ...
		        return internals.condition(schema, { ref: exports$1.ref(condition), is, then: rule.then, otherwise: rule.otherwise, break: rule.break });
		    }
...
const require$$1$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(deepEqual);

const require$$1$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(pinpoint);
...
function requireTrace () {
	...
	const DeepEqual = require$$1$3;
	const Pinpoint = require$$1$2;
...
const require$$1$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(merge);
...
const require$$2$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(ignore);
...
function requireValidator () {
	...
	(function (exports$1) {
		...
		internals.entry = function (value, schema, prefs) {
		    ...
		    const result = exports$1.validate(value, schema, state, prefs);
		...
		exports$1.validate = function (value, schema, state, prefs, overrides = {}) {
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(applyToDefaults);

const require$$3$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(topo);
...
function requireKeys () {
	...
	const ApplyToDefaults = require$$0;
	const Assert = require$$0$1;
	const Clone = require$$1$5;
	const Topo = require$$3$1;
...
const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(domain);

const require$$2 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(email);

const require$$3 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(ip);

const require$$4 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(escapeRegex);

const require$$5 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(tlds);

const require$$6 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(uri);
...
function requireString () {
	...
	const Assert = require$$0$1;
	const Domain = require$$1;
	const Email = require$$2;
	const Ip = require$$3;
	const EscapeRegex = require$$4;
	const Tlds = require$$5;
	const Uri = require$$6;
